...
class ProfileCardGenerator {
    constructor() {
        this.theme = {
            ...
            text: '#fffffffff',
            subText: '#b9c9e8',
            gradient: ['#020617', '#08152f', '#0b1f46'],
            accentGradient: ['#1749d8', '#4b76ff', '#4b76ff']
        };
    ...
    getColor(colorPath, fallback = '#020617') {
        try {
    ...
    drawBackground(ctx, width, height) {
        try {
            ...
            const color1 = this.getColor('gradient.0', '#020617');
            const color2 = this.getColor('gradient.1', '#08152f');
            const color3 = this.getColor('gradient.2', '#0b1f46');
            ...
            ctx.fillStyle = this.getColor('text', '#fffffffff');
    ...
    drawAccents(ctx, width, height) {
        try {
            ...
            // Safe accent colors
            const accent1 = this.getColor('accentGradient.0', '#1749d8');
            const accent2 = this.getColor('accentGradient.1', '#4b76ff');
            const accent3 = this.getColor('accentGradient.2', '#4b76ff');
    ...
    async drawAvatar(ctx, avatarURL, width, height) {
        try {
            ...
            ctx.shadowColor = this.getColor('highlight', '#1749d8');
            ctx.shadowBlur = 20;
            ...
            frameGradient.addColorStop(0.8, this.getColor('accentGradient.0', '#1749d8'));
            frameGradient.addColorStop(1, this.getColor('accentGradient.2', '#4b76ff'));
    ...
    drawMainContent(ctx, username, bio, width, height, fontPath) {
        try {
            ...
            titleGradient.addColorStop(0, this.getColor('text', '#fffffffff'));
            titleGradient.addColorStop(0.7, this.getColor('highlight', '#1749d8'));
            titleGradient.addColorStop(1, this.getColor('text', '#fffffffff'));
            
            ctx.fillStyle = titleGradient;
            ctx.font = `800 54px 'Segoe UI', 'Arial Black', sans-serif`;
            
            ctx.shadowColor = this.getColor('highlight', '#1749d8') + '60';
            ctx.shadowBlur = 8;
            ctx.shadowOffsetX = 2;
            ctx.shadowOffsetY = 2;
            ...
            lineGradient.addColorStop(0, this.getColor('accentGradient.0', '#1749d8'));
            lineGradient.addColorStop(0.5, this.getColor('accentGradient.1', '#4b76ff'));
    ...
    drawBorder(ctx, width, height) {
        try {
            ...
            borderGradient.addColorStop(0, this.getColor('highlight', '#1749d8'));
            borderGradient.addColorStop(0.5, this.getColor('accent', '#0b1f46'));
            borderGradient.addColorStop(1, this.getColor('highlight', '#1749d8'));
