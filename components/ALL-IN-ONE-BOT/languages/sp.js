module.exports = {
   ...
   botHelpFooter: "💡 ¡Usa comandos con barra (/) para una mejor experiencia!",
     ...
     serverVerificationLevels: {
         ...
         1: { name: "Low", desc: "Email verification required", emoji: "📧", color: "#1557ff" },
         2: { name: "Medium", desc: "Account age > 5 minutes", emoji: "⏰", color: "#285cff" },
         3: { name: "High", desc: "Member for 10+ minutes", emoji: "🔒", color: "#1557ff" },
         4: { name: "Very High", desc: "Phone number required", emoji: "📱", color: "#1749d8" }
     },
