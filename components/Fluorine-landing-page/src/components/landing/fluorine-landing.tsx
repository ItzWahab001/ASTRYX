  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      for (let i = 0; i < particles.length; i++) {
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (dist < 110) {
            ...
            ctx.strokeStyle = `rgba(10, 70, 255, ${alpha})`;
            ctx.lineWidth = 0.8;
            ctx.beginPath();
      ...
      for (const p of particles) {
        ...
        ctx.fillStyle = `rgba(61, 124, 255, ${p.alpha})`;
        ctx.beginPath();
...
function Background() {
  return (
    <div aria-hidden="true" className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_0%,rgba(10,70,255,0.22),transparent_40%),radial-gradient(circle_at_80%_20%,rgba(45,109,255,0.15),transparent_45%),radial-gradient(circle_at_50%_70%,rgba(23,73,216,0.18),transparent_50%),linear-gradient(180deg,#020617_0%,#030a1f_50%,#010515_100%)]" />
      ...
      <div
        className="absolute -right-32 top-1/3 h-[450px] w-[450px] rounded-full bg-blue-600/10 blur-[140px] animate-pulse-slow"
...
function ScrollProgress() {
  ...
  return (
    <div
      ...
      className="fixed top-0 left-0 h-[2.5px] z-[120] bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-300 transition-all duration-75 shadow-[0_0_10px_rgba(45,109,255,0.8)]"
    />
  );
}
...
function SpotlightCard({
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden rounded-2xl border border-blue-500/20 bg-gradient-to-br from-[#06102b] to-[#0a162b] transition-all duration-300 hover:border-blue-400/60 ${className}`}
    >
      ...
      <div
        ...
        style={{
          opacity,
          background: `radial-gradient(320px circle at ${position.x}px ${position.y}px, rgba(10, 70, 255, 0.22), transparent 70%)`,
        }}
      />
  ...
  return (
    <header className="fixed top-4 left-0 w-full z-[100] px-4 transition-all duration-500 ease-out">
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-3 lg:gap-4 relative z-10">
            ...
            <Link
              ...
              className="px-5 lg:px-6 py-2.5 rounded-full bg-blue-600 hover:bg-blue-500 text-white font-orbitron text-[11px] font-black uppercase tracking-[0.2em] transition-all hover:shadow-[0_0_24px_rgba(10,70,255,0.7)] active:scale-95"
            >
              Dashboard
            </Link>
          </div>
        ...
        {open && (
          <div className="mt-3 w-full rounded-2xl border border-blue-500/20 bg-[#06102b]/95 p-5 backdrop-blur-2xl md:hidden shadow-2xl animate-fade-in-up">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left animate-fade-in-up">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 mb-6 md:mb-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-600/10 border border-blue-500/30 shadow-[0_0_20px_rgba(10,70,255,0.2)]">
              ...
              <div className="inline-flex items-center gap-2 px-3.5 py-2 rounded-full bg-blue-950/60 border border-blue-500/30 text-xs text-slate-300">
                ...
                <span className="font-inter">
                  Developed by <span className="text-blue-400 font-bold font-orbitron">{siteConfig.developer}</span> · <span className="text-blue-300 font-bold font-orbitron">{siteConfig.teamName}</span>
                </span>
              </div>
            </div>
            ...
            <h1 className="font-orbitron text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-[1.1] tracking-tight text-white">
              The Ultimate
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-blue-500 to-blue-600 animate-gradient">
                Discord Bot
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8 md:mb-10">
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 opacity-0 group-hover:opacity-100 transition-opacity animate-gradient" />
              </Link>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-xs md:text-sm text-slate-400 font-inter">
              <div className="flex items-center gap-2">
                <CircleCheck className="w-4 h-4 text-blue-300" />
          ...
          <div className="w-full lg:w-1/2 relative animate-fade-in-up" style={{ animationDelay: "0.15s" }}>
            <div className="relative max-w-lg mx-auto aspect-square flex items-center justify-center">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                ...
                {/* Middle Dashed Ring */}
                <div className="absolute w-56 h-56 sm:w-72 sm:h-72 md:w-80 md:h-80 rounded-full border border-dashed border-blue-400/30 animate-[spin_16s_linear_infinite_reverse]" />
                {/* Inner Glowing Ring */}
              ...
              <div className="relative w-44 h-44 sm:w-52 sm:h-52 md:w-60 md:h-60 rounded-full bg-gradient-to-br from-blue-600/30 via-blue-600/15 to-blue-900/40 backdrop-blur-xl border border-blue-400/40 flex items-center justify-center shadow-[0_0_60px_rgba(10,70,255,0.4)] animate-float">
              ...
              <div className="absolute -top-2 right-4 sm:right-10 px-4 py-2.5 rounded-xl bg-[#07152f]/90 border border-blue-500/30 shadow-xl shadow-black/40 backdrop-blur-md flex items-center gap-2.5 animate-float">
                <Shield className="w-4 h-4 text-blue-400" />
              ...
              <button
                ...
                className="absolute top-1/2 -right-4 sm:-right-8 px-4 py-2.5 rounded-xl bg-[#07152f]/90 border border-blue-500/30 shadow-xl shadow-black/40 backdrop-blur-md flex items-center gap-2.5 animate-float hover:border-blue-400 hover:bg-blue-950/70 transition-all cursor-pointer text-left"
              ...
              <div
                className="absolute -bottom-2 left-4 sm:left-8 px-4 py-2.5 rounded-xl bg-[#07152f]/90 border border-blue-500/30 shadow-xl shadow-black/40 backdrop-blur-md flex items-center gap-2.5 animate-float"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {statsList.map((item) => (
            <SpotlightCard key={item.label} className="p-8 cursor-pointer shadow-lg shadow-black/30 group">
              {/* Icon box */}
              <div className="w-14 h-14 rounded-xl bg-blue-600/15 border border-blue-500/30 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:shadow-[0_0_24px_rgba(10,70,255,0.35)] transition-all duration-300">
                <item.icon className="h-7 w-7 text-blue-400 group-hover:text-blue-300 transition-colors" />
              </div>

              {/* Number */}
              <div className="text-3xl md:text-4xl lg:text-5xl font-orbitron font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-blue-300 to-white mb-2 break-words">
                {item.value}
              </div>
    ...
    <section id="features" className="py-24 relative z-20">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-600/10 border border-blue-500/30 mb-6 shadow-[0_0_15px_rgba(10,70,255,0.2)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {coreFeatures.map((item) => (
            <SpotlightCard key={item.title} className="p-8 cursor-pointer shadow-xl shadow-black/40 group">
              <div className="w-14 h-14 rounded-xl bg-blue-600/15 border border-blue-500/30 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:shadow-[0_0_24px_rgba(10,70,255,0.4)] transition-all duration-300">
    ...
    <section className="py-24 relative z-20 overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="relative w-full overflow-hidden py-6">
          {/* Gradient Masks */}
          <div className="absolute left-0 top-0 bottom-0 w-24 md:w-56 bg-gradient-to-r from-[#020617] via-[#020617]/80 to-transparent z-10 pointer-events-none" />
          <div className="absolute right-0 top-0 bottom-0 w-24 md:w-56 bg-gradient-to-l from-[#020617] via-[#020617]/80 to-transparent z-10 pointer-events-none" />
          ...
          <div className="flex gap-6 w-max animate-server-scroll hover:pause-animation">
            {[...guilds, ...guilds].map((guild, idx) => (
              <div
                key={`${guild.name}-${idx}`}
                className="relative w-[320px] sm:w-[350px] bg-[#07152f] rounded-2xl overflow-hidden flex-shrink-0 border border-blue-500/20 hover:border-blue-400 hover:-translate-y-2 hover:scale-[1.01] transition-all duration-300 ease-out cursor-pointer hover:shadow-[0_20px_40px_rgba(0,0,0,0.5),0_0_30px_rgba(10,70,255,0.3)] group"
              >
                {/* Banner image */}
                <div className="relative h-[135px] overflow-hidden bg-gradient-to-br from-blue-950 to-slate-900">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#07152f] via-transparent to-transparent opacity-80" />
                </div>

                {/* Server Avatar overlapping */}
                <div className="absolute top-[95px] left-5 w-18 h-18 rounded-full border-[4px] border-[#07152f] overflow-hidden shadow-[0_8px_16px_rgba(0,0,0,0.6)] z-20 bg-slate-900">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                ...
                {/* Verified Badge */}
                {guild.verified && (
                  <div className="absolute top-[98px] left-[70px] w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white text-xs font-bold border-[3px] border-[#07152f] z-30 shadow-md">
                    ✓
                  </div>
                )}
                  ...
                  <div className="flex gap-6 mb-4">
                    <div className="flex flex-col gap-0.5">
                      ...
                      <span className="text-white text-sm font-semibold flex items-center gap-1.5 font-inter">
                        <span className="inline-block w-2 h-2 bg-blue-400 rounded-full animate-pulse-glow" />
                        {guild.online}
                      </span>
                    </div>
    ...
    <section id="dashboard" className="py-24 relative z-20">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center mb-14">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-600/10 border border-blue-500/30 mb-4 shadow-[0_0_15px_rgba(10,70,255,0.2)]">
        ...
        {/* Console Hub Shell */}
        <div className="max-w-6xl mx-auto rounded-3xl border border-blue-500/25 bg-[#06102b]/90 p-5 md:p-8 shadow-[0_20px_60px_rgba(10,70,255,0.2)] backdrop-blur-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-6">
            {/* Sidebar Navigation */}
            <aside className="rounded-2xl border border-blue-500/15 bg-[#07152f] p-4 flex flex-col justify-between">
              <div>
              ...
              <div className="pt-4 border-t border-blue-500/15 mt-4">
                <div className="flex items-center justify-between text-xs text-slate-400 font-inter">
                  ...
                  <span className="flex items-center gap-1.5 text-blue-300 font-mono font-medium">
                    <span className="w-2 h-2 rounded-full bg-blue-400 animate-pulse-glow" /> 19ms
                  </span>
                </div>
              </div>
            </aside>
            ...
            <div className="rounded-2xl border border-blue-500/15 bg-[#07152f] p-5 md:p-6 min-h-[380px] flex flex-col justify-between">
                ...
                <div className="space-y-4">
                  <div className="flex flex-wrap items-center justify-between gap-2 border-b border-blue-500/15 pb-4">
                    ...
                    <span className="px-3 py-1 rounded-full bg-emerald-500/15 border border-emerald-500/30 text-emerald-300 text-xs font-orbitron font-bold flex items-center gap-1.5">
                      <span className="w-2 h-2 rounded-full bg-blue-400 animate-pulse-glow" /> DEFENSE ACTIVE
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div className="p-3.5 rounded-xl bg-blue-950/30 border border-blue-500/20">
                      ...
                      <p className="text-base font-orbitron font-bold text-blue-300 mt-1">Instant Rollback</p>
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-black/40 border border-blue-500/20 font-mono text-xs text-slate-300 space-y-1.5">
                    ...
                    {simLogs.map((log, i) => (
                      <p key={i} className="flex gap-2">
                        ...
                        <span className={log.type === "ok" ? "text-blue-300" : log.type === "cmd" ? "text-blue-300" : "text-blue-400"}>
                          {log.msg}
                        </span>
                      </p>
                    ))}
              ...
              {activeTab === "music" && (
                <div className="space-y-4">
                  ...
                  <div className="p-4 rounded-2xl bg-gradient-to-r from-blue-950/50 to-[#071a3d] border border-blue-500/25 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex items-end gap-1.5 h-8 px-4">
                      {[12, 24, 18, 28, 16, 26, 14, 28, 22, 16, 25, 18].map((h, idx) => (
                        <div
                          ...
                          className="w-1.5 bg-gradient-to-t from-blue-600 to-blue-500 rounded-full animate-soundwave"
                        />
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
                    ...
                    <button
                      ...
                      className="p-3 rounded-xl bg-blue-950/30 hover:bg-blue-900/40 border border-blue-500/20 text-xs font-orbitron font-bold text-white transition-all flex items-center justify-center gap-2"
                    >
                      <Sliders className="w-4 h-4 text-blue-300" /> 8D Surround
                    </button>
                    <button
                      type="button"
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 rounded-xl bg-black/60 border border-blue-500/30 font-mono text-xs min-h-[160px] text-slate-200">
                    ...
                    <div className="mt-3 p-3 rounded-lg bg-[#0b162c] border-l-4 border-blue-500 text-xs text-slate-300 space-y-1">
                      ...
                      <p className="text-blue-300">✓ Command verified and dispatched across guild cluster</p>
              ...
              {activeTab === "telemetry" && (
                <div className="space-y-4">
                  <div className="flex items-center justify-between border-b border-blue-500/15 pb-4">
                    ...
                    <span className="text-xs font-mono text-blue-300 font-bold">+18.4% Peak Load</span>
                  </div>

                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    {[
                      { label: "Shard Health", val: "100% OK", col: "text-blue-300" },
                      { label: "Active Nodes", val: "16 Dedicated", col: "text-blue-400" },
                      { label: "Events/sec", val: "4,920/s", col: "text-blue-300" },
                    ...
                    <div className="flex h-24 items-end gap-2 pt-2">
                      {[35, 48, 42, 65, 82, 70, 94, 88, 76, 92, 100, 85].map((val, idx) => (
                        <div
                          key={idx}
                          style={{ height: `${val}%` }}
                          className="flex-1 rounded-sm bg-gradient-to-t from-blue-600/40 via-blue-500/80 to-blue-500 hover:brightness-125 transition-all"
                        />
                      ))}
                    </div>
                  </div>
  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full max-w-4xl max-h-[85vh] overflow-hidden rounded-3xl border border-blue-500/30 bg-[#06102b] shadow-[0_0_80px_rgba(10,70,255,0.35)] flex flex-col"
      >
        {/* Modal Header */}
        <div className="p-6 border-b border-blue-500/20 flex items-center justify-between bg-[#07152f]">
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-[#07152f] border border-blue-500/30 rounded-2xl pl-12 pr-4 py-3.5 text-sm text-white placeholder:text-slate-500 focus:border-blue-400 transition-colors outline-none"
              autoFocus
            />
          </div>
            ...
            {filteredCommands.map((cmd) => {
              ...
              return (
                <div
                  ...
                  className="p-4 rounded-xl border border-blue-500/15 bg-[#07152f] hover:border-blue-400/50 hover:bg-[#0c1c38] transition-all cursor-pointer group relative"
                ...
                >
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="font-orbitron font-bold text-sm text-blue-300 group-hover:text-white transition-colors flex items-center gap-1.5">
                      {cmd.name}
                      {isCopied ? (
                        <span className="text-[10px] text-blue-300 font-mono bg-emerald-500/20 px-1.5 py-0.5 rounded">
                          Copied! ✓
                        </span>
                      ) : (
                  ...
                  <div className="space-y-0.5 font-mono text-[10px] pt-2 border-t border-white/5">
                    ...
                    <p className="text-slate-500 truncate">
                      Permission: <span className="text-blue-300">{cmd.permission}</span>
                    </p>
                  </div>
                </div>
              );
        ...
        {/* Modal Footer */}
        <div className="p-4 border-t border-blue-500/20 bg-[#07152f] flex items-center justify-between text-xs text-slate-400 font-mono">
...
function PricingModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    ...
    >
      <div
        onClick={(e) => e.stopPropagation()}
        className="relative w-full max-w-5xl max-h-[90vh] overflow-hidden rounded-3xl border border-blue-500/30 bg-[#06102b] shadow-[0_0_80px_rgba(10,70,255,0.35)] flex flex-col"
      >
        {/* Modal Header */}
        <div className="p-6 border-b border-blue-500/20 flex items-center justify-between bg-[#07152f]">
          <div className="flex items-center gap-3">
            ...
            {siteConfig.pricing.map((plan) => (
              <div
                ...
                className={`relative rounded-2xl p-6 transition-all flex flex-col justify-between ${
                  plan.highlighted
                    ? "bg-gradient-to-b from-[#08245a] to-[#061936] border-2 border-blue-400 shadow-[0_0_40px_rgba(10,70,255,0.35)]"
    ...
    <section className="py-28 relative overflow-hidden z-20">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-600/10 border border-blue-500/30 mb-8 shadow-[0_0_20px_rgba(10,70,255,0.2)]">
...
function FAQModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    ...
    >
      <div
        onClick={(e) => e.stopPropagation()}
        className="relative w-full max-w-3xl max-h-[85vh] overflow-hidden rounded-3xl border border-blue-500/30 bg-[#06102b] shadow-[0_0_80px_rgba(10,70,255,0.35)] flex flex-col"
      >
        {/* Modal Header */}
        <div className="p-6 border-b border-blue-500/20 flex items-center justify-between bg-[#07152f]">
          <div className="flex items-center gap-3">
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-4">
          ...
          <div className="relative mb-2">
            ...
            <input
              ...
              className="w-full bg-[#07152f] border border-blue-500/30 rounded-2xl pl-11 pr-4 py-3 text-sm text-white placeholder:text-slate-500 focus:border-blue-400 transition-colors outline-none"
              autoFocus
            />
          </div>
        ...
        <div className="border-t border-blue-500/15 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-400 gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-2 text-center sm:text-left">
            ...
            <p className="font-mono text-slate-300">
              ...
              {" · "}
              Development Team{" "}
              <span className="text-blue-300 font-bold font-orbitron">
                {siteConfig.teamName}
              </span>
            </p>
          </div>
