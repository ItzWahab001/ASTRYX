...
class EnhancedMusicCard {
    constructor() {
        this.themes = {
            modern: {
                ...
                visualizerColor: '#dbe7ff' // Golden yellow
            },
            dark: {
                primaryColor: '#4b76ff',
            ...
            spotify: {
                ...
                accentColor: '#fffffffff',
                textPrimary: '#fffffffff',
                textSecondary: '#B3B3B3',
                textMuted: '#727272',
                background: 'linear-gradient(135deg, #191414 0%, #2d6dff 100%)',
            ...
            lavalink: {
                primaryColor: '#5b83ff',
                secondaryColor: '#1749d8',
                accentColor: '#F59E0B',
                textPrimary: '#fffffffff',
                textSecondary: '#e7efff',
                textMuted: '#A78BFA',
                background: 'linear-gradient(135deg, #5b83ff 0%, #1749d8 100%)',
                cardBg: 'rgba(0, 0, 0, 0.3)',
                badgeBg: '#7C3AED',
                watermarkColor: 'rgba(220, 146, 255, 0.12)',
                visualizerColor: '#dbe7ff' // Golden yellow for visualizer
            }
        };
    }
    ...
    drawEnhancedVisualizer(ctx, config, theme) {
        ...
        for (let i = 0; i < barCount; i++) {
            ...
            barGradient.addColorStop(0.7, '#285cff');
            barGradient.addColorStop(1, '#285cff');
    ...
    drawEnhancedVisualizer(ctx, config, theme) {
        ...
        for (let i = 0; i < barCount; i++) {
            ...
            barGradient.addColorStop(0.7, '#285cff'); // Orange middle
            barGradient.addColorStop(1, '#285cff'); // Orange-red bottom
