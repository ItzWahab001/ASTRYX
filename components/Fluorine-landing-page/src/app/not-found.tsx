...
export default function NotFound() {
  return (
    <main className="min-h-screen bg-[#020617] text-slate-100 flex items-center justify-center p-6 relative overflow-hidden font-inter">
      {/* Glow backgrounds */}
      ...
      <div className="relative z-10 max-w-md w-full text-center p-8 rounded-3xl border border-blue-500/20 bg-[#06102b]/80 backdrop-blur-2xl shadow-2xl">
